import WHYUS from '../assets/images/whyusimage.jpg'
import Image from 'next/image'


const WhyThisWebsite = () => {
  return (
<div class="container my-72 mx-auto md:px-6">
  <section class="mb-32">
    <div
      class="block  bg-whit">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
          <div class="px-6 py-12 md:px-12">
            ...
            <p class="mb-6 pb-2 text-neutral-500 dark:text-neutral-300">
              ...
              بفضل تنوع واسع في العروض والخدمات، نسعى جاهدين لتحقيق رضاكم التام. فنحن لا نكتفي بتوفير العقارات فقط، بل نسعى أيضًا لتقديم تجربة استخدام مميزة ومريحة لجميع زوارنا. اختيارنا يعني اختيار الجودة والموثوقية، ونحن نتطلع لخدمتكم بكل احترافية وكفاءة.
            </p>
