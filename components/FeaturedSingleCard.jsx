...
const FeaturedSingleCard = ({property}) => {
    ...
    <div className="p-6">
      ...
      <div className="flex justify-center gap-4 text-gray-500 mb-4">
        <p>
         <FaBed className="inline-block mr-2" />{property.beds} {' '}
          <span className="md:hidden lg:inline">سرير</span>
        </p>
        <p>
        ...
        <FaRulerCombined className="inline-block mr-2" />
         {property.square_feet} {' '}<span className="md:hidden lg:inline">مساحة</span>
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        <Link
          ...
          className="h-[36px] bg-purple-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-center text-sm"
        >
          تفاصيل
        </Link>
      </div>
